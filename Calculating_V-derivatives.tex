...
However, we should only consider a subset of function $f$, which has convergent integral on $\mathbb{Q}_p$. Using a test function
\begin{equation}
f(x)=
\begin{cases}
1\quad x\in \mathbb{Z}_p\\
0\quad \text{otherwise},
\end{cases}
\end{equation}
one can show that the most severe discrepancy lives in the 
\end{document}
